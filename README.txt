...
After editing notepad.ui - in project folder:
pyside6-uic resources\notepad.ui > views\main_view_ui.py
Source (Option A): https://doc.qt.io/qtforpython/tutorials/basictutorial/uifiles.html
...
- [ ] Use of SSML with SSML tags
    ...
    - [ ] SSML tags are not visible as SSML tags (instead it is visualized with
        color, format etc.)
- [ ] If everything is implemented, create YouTube-account, rewrite everything
    and let it looks like it was written in some days
